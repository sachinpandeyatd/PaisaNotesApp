...
class TokenManager @Inject constructor(
    ...
    private val prefs: SharedPreferences = context.getSharedPreferences("paisa_prefs", Context.MODE_PRIVATE)
    ...
    fun clearToken() {
        prefs.edit().remove("jwt_token").remove("last_sync_time").apply()
    }
